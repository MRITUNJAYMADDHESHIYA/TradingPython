...
def update_page(n_intervals, selected_trade):
    ...
    deals = mt5.history_orders_total(datetime(2023, 1, 1), datetime.now())

    # if deals is None or len(deals) == 0:
    #     print("No deals found for the specified date range.")
    #     return html.Div("No deals available.")  # Return an empty placeholder to avoid breaking the app
    # else:
