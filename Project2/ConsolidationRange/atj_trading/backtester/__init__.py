...
def get_ohlc_history(symbol, timeframe, date_from, date_to, additional_columns=[]):
    ...
    #     raise ValueError("No data returned for the specified symbol and timeframe.")
...
# # Define parameters
# symbol = "USDJPYm"  # Symbol to fetch data for
# timeframe = mt5.TIMEFRAME_H1  # 1-hour time frame
# date_from = datetime(2023, 1, 1)  # Start date
# date_to = datetime(2023, 2, 1)    # End date

# # Fetch OHLC data
# ohlc_df = get_ohlc_history(symbol, timeframe, date_from, date_to)

# # Display the first few rows of the OHLC data
# print(ohlc_df.head())
